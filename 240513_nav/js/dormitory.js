...
const initRoomName = () => {
    // 모든 호실 표시하기      
    // allData에서 방 정보 가져와서 <option value="401">401호</option> 만들어서 roomSelect의 자식으로 붙이기
...
const initTable = () => {
    // 사용자가 예약한 내용들(reservations) 보여주기
